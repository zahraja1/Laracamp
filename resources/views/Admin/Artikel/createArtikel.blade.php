                    ...
                    <form action="{{ route('admin.create.artikel') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" id="title" placeholder="Masukkan judul artikel ...">
                                @error('title')
                            ...
                            <div class="form-group">
                                ...
                                <select class="custom-select form-control-border  @error('tags') is-invalid @enderror" required name="tags" id="tags">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control  @error('artikel') is-invalid @enderror" id="artikel" name="artikel" rows="3" placeholder="Enter Article ..."></textarea>
                                @error('artikel')
                                <div class="invalid-feedback">
                                    <strong>{{ $message}}</strong>
                                </div>
