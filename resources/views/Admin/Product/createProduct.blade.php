                    ...
                    <form action="{{route('Product.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div  class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_produk" class="form-control @error('nama_produk') is-invalid @enderror" id="nama_produk" placeholder="Masukkan Nama_produk Product ...">
                                @error('nama_produk')
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="harga" class="form-control @error('harga') is-invalid @enderror" id="harga" placeholder="Masukkan harga Product ...">
                                @error('harga')
                                <div class="invalid-feedback">
                                    <strong>{{ $message}}</strong>
                                </div>
